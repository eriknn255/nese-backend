...
// ==========================================================================
// ABAS — Usuários / Prestadores / Log de auditoria, mesmo padrão
// data-aba do dashboard, versão simplificada (sem sidebar retrátil).
// Gestão de LOGIN interno não fica aqui: é conta de funcionário, não
// moderação de usuário final — vive na página criar-acesso/.
// ==========================================================================
