...
// Fotos/vídeos servidos direto da raiz de storage/<id>/... (capa, avatar,
...
// storage/ fica FORA de src/ de propósito (irmã dela, dentro de backend/):
// é dado gerado em runtime (upload de usuário), não código-fonte — não
// deveria estar na mesma árvore que git gerencia como source tree, senão
// um `git clean`/deploy que mexe em src/ arrisca apagar upload de gente
// de verdade junto.
