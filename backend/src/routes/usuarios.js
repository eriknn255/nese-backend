...
// ==========================================================================
// APARELHOS DA CONTA (push)
//
// O token do FCM é do APARELHO; a sessão é da CONTA. O mesmo aparelho pode
// trocar de dono (alguém sai, outra pessoa entra), então a chave primária é o
// token e o usuario_id é sobrescrito no conflito: o vínculo antigo morre no
// mesmo instante em que o novo nasce, sem deixar um aparelho recebendo aviso
// de duas contas.
//
// ESTAS DUAS ROTAS PRECISAM FICAR ANTES DE `router.delete("/:id")` (mais
// abaixo). O Express casa na ordem de registro: se o DELETE /dispositivos
// vier depois, "dispositivos" cai como valor de `:id` e a chamada entra na
// rota de EXCLUIR CONTA. O exigirUsuario barraria por o id não bater com a
// sessão, mas depender disso é sorte, não projeto.
// ==========================================================================
...
//
// O token vai no CORPO, não na URL: são ~160 caracteres com coisas que
// precisariam de escape em path. O app manda com
